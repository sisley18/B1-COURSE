// Units 7-8 Data with EXPANDED TEXTS
courseData.units.push(
    {
        id: 7, title: "Urban Life", topic: "Smart Cities & Sustainable Infrastructure",
        listening: {
        ...
        vocabulary: [
            { word: "Congestion", ipa: "kənˈdʒestʃən", def: "Overcrowding causing slow movement, especially traffic" },
            { word: "Infrastructure", ipa: "ˈɪnfrəˌstrʌktʃər", def: "Basic physical systems of a city or country" },
            { word: "Commute", ipa: "kəˈmjuːt", def: "Regular journey between home and work" },
            { word: "Sprawl", ipa: "sprɔːl", def: "Spread of urban development into rural areas" },
            { word: "Sustainable", ipa: "səˈsteɪnəbəl", def: "Able to continue without depleting resources" },
            { word: "Density", ipa: "ˈdensəti", def: "Number of people or things in a given area" },
            { word: "Transit", ipa: "ˈtrænzɪt", def: "Public transportation system" },
            { word: "Pedestrian", ipa: "pəˈdestriən", def: "Person traveling on foot" },
            { word: "Zoning", ipa: "ˈzəʊnɪŋ", def: "Division of city into designated areas" },
            { word: "Metropolitan", ipa: "ˌmetrəˈpɒlɪtən", def: "Relating to a large city and its suburbs" }
        ],
        collocations: [
            { pair: ["Traffic", "Jam"], context: "Stuck in a traffic _____ for two hours.", distractors: ["Block", "Stop"] },
            { pair: ["Public", "Transport"], context: "Take public _____ to reduce emissions.", distractors: ["Bus", "Train"] },
            { pair: ["Rush", "Hour"], context: "Avoid traveling during rush _____.", distractors: ["Time", "Period"] },
            { pair: ["City", "Centre"], context: "Meet me in the city _____.", distractors: ["Middle", "Heart"] },
            { pair: ["Road", "Network"], context: "The road _____ needs improvement.", distractors: ["System", "Web"] },
            { pair: ["Urban", "Planning"], context: "Good urban _____ creates livable cities.", distractors: ["Design", "Building"] },
            { pair: ["Green", "Space"], context: "Parks provide essential green _____.", distractors: ["Area", "Park"] },
            { pair: ["High", "Rise"], context: "High-_____ buildings dominate the skyline.", distractors: ["Building", "Tower"] },
            { pair: ["Bike", "Lane"], context: "Use the bike _____ for safety.", distractors: ["Path", "Road"] },
            { pair: ["Smart", "City"], context: "A smart _____ uses technology efficiently.", distractors: ["Town", "Place"] }
        ],
        pronunciation: {
            word_stress: [
                ...
                { word: "DEN-si-ty", syllables: ["DEN", "si", "ty"], correct: 0 },
                { word: "TRAN-sit", syllables: ["TRAN", "sit"], correct: 0 },
                { word: "pe-DES-tri-an", syllables: ["pe", "DES", "tri", "an"], correct: 1 },
                { word: "ZO-ning", syllables: ["ZO", "ning"], correct: 0 },
                { word: "me-tro-PO-li-tan", syllables: ["me", "tro", "PO", "li", "tan"], correct: 2 },
                { word: "UR-ban", syllables: ["UR", "ban"], correct: 0 }
            ],
            sentence_stress: [
                { sentence: "Cities need more green spaces for everyone.", stressed: ["Cities", "need", "green", "spaces", "everyone"] },
                { sentence: "Walking is healthier than driving always.", stressed: ["Walking", "healthier", "driving", "always"] },
                { sentence: "Traffic congestion wastes hours every day.", stressed: ["Traffic", "congestion", "wastes", "hours", "day"] },
                { sentence: "Public transport reduces carbon emissions significantly.", stressed: ["Public", "transport", "reduces", "carbon", "emissions"] },
                { sentence: "Smart planning creates more livable neighborhoods.", stressed: ["Smart", "planning", "creates", "livable", "neighborhoods"] },
                { sentence: "Higher density means better access to services.", stressed: ["Higher", "density", "better", "access", "services"] },
                { sentence: "Bicycles are efficient for short urban trips.", stressed: ["Bicycles", "efficient", "short", "urban", "trips"] },
    ...
    },
    {
        ...
        vocabulary: [
            { word: "Curriculum", ipa: "kəˈrɪkjələm", def: "The subjects and content taught in a school" },
            { word: "Pedagogy", ipa: "ˈpedəɡɒdʒi", def: "The method and practice of teaching" },
            { word: "Literacy", ipa: "ˈlɪtərəsi", def: "Ability to read, write, and use information" },
            { word: "Tutor", ipa: "ˈtjuːtər", def: "A private teacher for individual instruction" },
            { word: "Virtual", ipa: "ˈvɜːtʃuəl", def: "Simulated by computer technology" },
            { word: "Gamification", ipa: "ˌɡæmɪfɪˈkeɪʃən", def: "Using game elements in non-game contexts" },
            { word: "Assessment", ipa: "əˈsesmənt", def: "Evaluation of student performance or knowledge" },
            { word: "Credential", ipa: "krəˈdenʃəl", def: "A qualification or certification" },
            { word: "Dissertation", ipa: "ˌdɪsəˈteɪʃən", def: "A long essay on a subject for a degree" },
            { word: "Scholarship", ipa: "ˈskɒləʃɪp", def: "Financial aid for education based on achievement" }
        ],
        collocations: [
            { pair: ["Higher", "Education"], context: "Higher _____ prepares students for careers.", distractors: ["Learning", "Study"] },
            { pair: ["Critical", "Thinking"], context: "Critical _____ skills are essential.", distractors: ["Mind", "Brain"] },
            { pair: ["Online", "Course"], context: "Take an online _____ to learn new skills.", distractors: ["Class", "Lesson"] },
            { pair: ["Student", "Loan"], context: "Pay off your student _____ gradually.", distractors: ["Debt", "Money"] },
            { pair: ["Academic", "Year"], context: "The academic _____ starts in September.", distractors: ["Time", "Period"] },
            { pair: ["Learning", "Curve"], context: "There's a steep learning _____ at first.", distractors: ["Line", "Path"] },
            { pair: ["Gap", "Year"], context: "Take a gap _____ before university.", distractors: ["Time", "Break"] },
            { pair: ["Distance", "Learning"], context: "Distance _____ offers flexibility.", distractors: ["Study", "Education"] },
            { pair: ["Peer", "Review"], context: "Submit your work for peer _____.", distractors: ["Check", "Read"] },
            { pair: ["Lifelong", "Learning"], context: "Embrace lifelong _____ for success.", distractors: ["Study", "Education"] }
        ],
        pronunciation: {
            word_stress: [
                ...
                { word: "TU-tor", syllables: ["TU", "tor"], correct: 0 },
                { word: "VIR-tu-al", syllables: ["VIR", "tu", "al"], correct: 0 },
                { word: "ga-mi-fi-CA-tion", syllables: ["ga", "mi", "fi", "CA", "tion"], correct: 3 },
                { word: "as-SESS-ment", syllables: ["as", "SESS", "ment"], correct: 1 },
                { word: "cre-DEN-tial", syllables: ["cre", "DEN", "tial"], correct: 1 },
                { word: "dis-ser-TA-tion", syllables: ["dis", "ser", "TA", "tion"], correct: 2 },
                { word: "SCHO-lar-ship", syllables: ["SCHO", "lar", "ship"], correct: 0 }
            ],
            sentence_stress: [
                { sentence: "Education opens doors to countless opportunities.", stressed: ["Education", "opens", "doors", "countless", "opportunities"] },
                { sentence: "Learning never stops throughout our entire lives.", stressed: ["Learning", "never", "stops", "entire", "lives"] },
                { sentence: "Knowledge empowers people to change the world.", stressed: ["Knowledge", "empowers", "people", "change", "world"] },
                { sentence: "Skills matter more than ever in today's economy.", stressed: ["Skills", "matter", "today's", "economy"] },
                { sentence: "Reading expands our minds and perspectives daily.", stressed: ["Reading", "expands", "minds", "perspectives", "daily"] },
                { sentence: "Curiosity is the foundation of all great discovery.", stressed: ["Curiosity", "foundation", "great", "discovery"] },
                { sentence: "Great teachers inspire students to achieve more.", stressed: ["Great", "teachers", "inspire", "students", "achieve"] },
