// Units 3-4 Data with EXPANDED TEXTS
courseData.units.push(
    {
        id: 3, title: "Our Planet", topic: "Sustainability & Climate Change",
        listening: {
        ...
        vocabulary: [
            { word: "Sustainable", ipa: "səˈsteɪnəbəl", def: "Capable of being maintained at a steady level without depleting resources" },
            ...
            { word: "Emission", ipa: "ɪˈmɪʃən", def: "The production and discharge of gases, especially pollutants" },
            { word: "Conservation", ipa: "ˌkɒnsəˈveɪʃən", def: "Prevention of wasteful use of a resource" },
            { word: "Ecosystem", ipa: "ˈiːkəʊˌsɪstəm", def: "A biological community of interacting organisms and their environment" },
            { word: "Footprint", ipa: "ˈfʊtˌprɪnt", def: "The environmental impact of human activities" },
            { word: "Recycling", ipa: "ˌriːˈsaɪklɪŋ", def: "Converting waste into reusable material" },
            { word: "Pollution", ipa: "pəˈluːʃən", def: "The presence of harmful substances in the environment" },
            { word: "Climate", ipa: "ˈklaɪmət", def: "Long-term weather patterns in a region" }
        ],
        collocations: [
            { pair: ["Carbon", "Footprint"], context: "Reduce your carbon _____ by using public transport.", distractors: ["Step", "Print"] },
            { pair: ["Renewable", "Energy"], context: "Invest in _____ energy for a sustainable future.", distractors: ["New", "Fresh"] },
            { pair: ["Climate", "Change"], context: "Climate _____ is the greatest threat to humanity.", distractors: ["Shift", "Move"] },
            { pair: ["Global", "Warming"], context: "Global _____ is causing sea levels to rise.", distractors: ["Heating", "Hot"] },
            { pair: ["Plastic", "Pollution"], context: "Plastic _____ is destroying our oceans.", distractors: ["Waste", "Junk"] },
            { pair: ["Zero", "Waste"], context: "The zero _____ movement aims to eliminate trash.", distractors: ["Trash", "Junk"] },
            { pair: ["Solar", "Panel"], context: "Install a solar _____ on your roof.", distractors: ["Board", "Plate"] },
            { pair: ["Wind", "Turbine"], context: "Wind _____s generate clean electricity.", distractors: ["Mill", "Fan"] },
            { pair: ["Greenhouse", "Gas"], context: "Greenhouse _____es trap heat in the atmosphere.", distractors: ["Air", "Smoke"] },
            { pair: ["Eco", "Friendly"], context: "Choose eco-_____ products when shopping.", distractors: ["Good", "Nice"] }
        ],
        pronunciation: {
            word_stress: [
                ...
                { word: "e-MIS-sion", syllables: ["e", "MIS", "sion"], correct: 1 },
                { word: "con-ser-VA-tion", syllables: ["con", "ser", "VA", "tion"], correct: 2 },
                { word: "E-co-sys-tem", syllables: ["E", "co", "sys", "tem"], correct: 0 },
                { word: "re-CY-cling", syllables: ["re", "CY", "cling"], correct: 1 },
                { word: "pol-LU-tion", syllables: ["pol", "LU", "tion"], correct: 1 },
                { word: "CLI-mate", syllables: ["CLI", "mate"], correct: 0 },
                { word: "re-NEW-a-ble", syllables: ["re", "NEW", "a", "ble"], correct: 1 }
            ],
            sentence_stress: [
                { sentence: "Climate change threatens our planet.", stressed: ["Climate", "change", "threatens", "planet"] },
                { sentence: "We must reduce our carbon footprint.", stressed: ["must", "reduce", "carbon", "footprint"] },
                { sentence: "Renewable energy is the future.", stressed: ["Renewable", "energy", "future"] },
                { sentence: "Every individual action counts.", stressed: ["Every", "individual", "action", "counts"] },
                { sentence: "Plastic pollution destroys ocean life.", stressed: ["Plastic", "pollution", "destroys", "ocean", "life"] },
                { sentence: "Recycling reduces waste significantly.", stressed: ["Recycling", "reduces", "waste", "significantly"] },
                { sentence: "Protect the environment for future generations.", stressed: ["Protect", "environment", "future", "generations"] },
    ...
    },
    {
        ...
        vocabulary: [
            { word: "Viral", ipa: "ˈvaɪrəl", def: "Spreading rapidly through electronic sharing" },
            { word: "Misinformation", ipa: "ˌmɪsɪnfəˈmeɪʃən", def: "False or inaccurate information spread unintentionally" },
            { word: "Disinformation", ipa: "ˌdɪsɪnfəˈmeɪʃən", def: "False information deliberately spread to deceive" },
            { word: "Algorithm", ipa: "ˈælɡərɪðəm", def: "A set of rules used by computers to solve problems or make decisions" },
            { word: "Polarization", ipa: "ˌpəʊləraɪˈzeɪʃən", def: "Division into sharply contrasting groups or opinions" },
            { word: "Bias", ipa: "ˈbaɪəs", def: "Prejudice in favor of or against something" },
            { word: "Verify", ipa: "ˈverɪfaɪ", def: "To confirm the truth or accuracy of something" },
            { word: "Credible", ipa: "ˈkredəbəl", def: "Capable of being believed; trustworthy" },
            { word: "Source", ipa: "sɔːs", def: "The origin or provider of information" },
            { word: "Platform", ipa: "ˈplætfɔːm", def: "A digital service enabling communication or commerce" }
        ],
        collocations: [
            { pair: ["Fake", "News"], context: "Be careful of fake _____ on social media.", distractors: ["Info", "Story"] },
            { pair: ["Viral", "Content"], context: "Viral _____ spreads rapidly across platforms.", distractors: ["Post", "Video"] },
            { pair: ["Social", "Media"], context: "Social _____ has changed how we communicate.", distractors: ["Net", "Web"] },
            { pair: ["Breaking", "News"], context: "Breaking _____ just came in from the capital.", distractors: ["Story", "Event"] },
            { pair: ["Fact", "Check"], context: "Always fact _____ before sharing information.", distractors: ["Verify", "Test"] },
            { pair: ["Click", "Bait"], context: "That headline is just click _____ to get views.", distractors: ["Trap", "Hook"] },
            { pair: ["Echo", "Chamber"], context: "Social media creates echo _____s of similar opinions.", distractors: ["Room", "Box"] },
            { pair: ["Filter", "Bubble"], context: "Algorithms create filter _____s around users.", distractors: ["Ball", "Circle"] },
            { pair: ["News", "Feed"], context: "Check your news _____ for updates.", distractors: ["Stream", "Flow"] },
            { pair: ["Online", "Platform"], context: "Choose a reliable online _____ for news.", distractors: ["Site", "Page"] }
        ],
        pronunciation: {
            word_stress: [
                ...
                { word: "VI-ral", syllables: ["VI", "ral"], correct: 0 },
                { word: "CRE-di-ble", syllables: ["CRE", "di", "ble"], correct: 0 },
                { word: "VE-ri-fy", syllables: ["VE", "ri", "fy"], correct: 0 },
                { word: "BI-as", syllables: ["BI", "as"], correct: 0 },
                { word: "PLAT-form", syllables: ["PLAT", "form"], correct: 0 },
                { word: "po-la-ri-ZA-tion", syllables: ["po", "la", "ri", "ZA", "tion"], correct: 3 },
                { word: "dis-in-for-MA-tion", syllables: ["dis", "in", "for", "MA", "tion"], correct: 3 }
            ],
            sentence_stress: [
                { sentence: "Always verify information before sharing.", stressed: ["Always", "verify", "information", "before", "sharing"] },
                { sentence: "Check multiple sources for accuracy.", stressed: ["Check", "multiple", "sources", "accuracy"] },
                { sentence: "Truth matters more than being first.", stressed: ["Truth", "matters", "more", "first"] },
                { sentence: "Critical thinking protects against manipulation.", stressed: ["Critical", "thinking", "protects", "manipulation"] },
                { sentence: "Question everything you read online.", stressed: ["Question", "everything", "read", "online"] },
                { sentence: "Media literacy should be taught in schools.", stressed: ["Media", "literacy", "taught", "schools"] },
                { sentence: "Fake news undermines public trust.", stressed: ["Fake", "news", "undermines", "public", "trust"] },
